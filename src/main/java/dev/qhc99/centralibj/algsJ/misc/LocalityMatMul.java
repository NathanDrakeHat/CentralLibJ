...
public class LocalityMatMul {
    ...
    public static void naiveMatMul(float[][] m1, float[][] m2, float[][] m3) {
        int size_a = m1.length;
        int size_b = m2.length;
        int size_c = m2[0].length;
    ...
    public static void runDemo(int sizeA, int sizeB, int sizeC) {
