...
import org.nathan.centralib.algsJ.dataStruc.DynamicPriQueue;
import org.nathan.centralib.algsJ.dataStruc.TernaryTries;
import org.nathan.centralib.utils.tuples.Triad;
...
public class ACM0x10{
  ...
  public static @NotNull Map<String, Tuple<String, Integer>> period(@NotNull String txt){
    var next = org.nathan.centralib.algsJ.strMatch.KMP.computePrefixFunction(txt);
