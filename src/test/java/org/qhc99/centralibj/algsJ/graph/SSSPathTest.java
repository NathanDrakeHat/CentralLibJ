...
class SSSPathTest{
  ...
  void shortestPathOfDAGTest(){
    ...
    var l = vertices.stream().sorted(Comparator.comparing(BFS.Vert::identity)).toList();
  ...
  void DijkstraFibonacciHeapTest(){
    ...
    var vertices =
            dijkstraFibGraph.allVertices().stream().sorted(Comparator.comparing(BFS.Vert::identity)).toList();
  ...
  void DijkstraMinHeapTest(){
    ...
    var vertices =
            dijkstraMinHeapGraph.allVertices().stream().sorted(Comparator.comparing(BFS.Vert::identity)).toList();
    assertNull(vertices.get(0).getParent());
