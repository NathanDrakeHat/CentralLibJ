...
class OrthoLineIntersectTest{
  List<Tuple<Tuple<Integer,Integer>, Tuple<Integer,Integer>>> linesData;
  {
    ...
    pointsData.add(new Tuple<>(82,448-284));
    pointsData.add(new Tuple<>(301,448-285));

    pointsData.add(new Tuple<>(115,448-238));
