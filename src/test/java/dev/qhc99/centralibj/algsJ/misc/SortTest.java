...
public class SortTest{
...

  {
    ...
    for(int i = 0; i < iteration; i++){
      ...
      quickSort3WayCase[i] = ArrayUtils.randomDoubleArray(-bound, bound, len);
    }
  }
...

  {
    ...
    for(int i = 0; i < iteration; i++){
      int len = rand.nextInt(10) + 20;
      int bound = rand.nextInt(5) + 10;
      shellSortCase[i] = ArrayUtils.randomDoubleArray(-bound, bound, len);
    }
  }
...

  {
    ...
    for(int i = 0; i < iteration; i++){
      int len = rand.nextInt(10) + 20;
      int bound = rand.nextInt(5) + 10;
      insertionSortCase[i] = ArrayUtils.randomDoubleArray(-bound, bound, len);
    }
  }
...

  {
    ...
    for(int i = 0; i < iteration; i++){
      int len = rand.nextInt(10) + 20;
      int bound = rand.nextInt(5) + 10;
      selectionSortCase[i] = ArrayUtils.randomDoubleArray(-bound, bound, len);
    }
  }
...

  {
    ...
    for(int i = 0; i < iteration; i++){
      int len = rand.nextInt(10) + 20;
      int bound = rand.nextInt(5) + 10;
      iterMergeSortCase[i] = ArrayUtils.randomDoubleArray(-bound, bound, len);
    }
  }
...

  {
    ...
    for(int i = 0; i < iteration; i++){
      int len = rand.nextInt(10) + 20;
      int bound = rand.nextInt(5) + 10;
      recurMergeSortCase[i] = ArrayUtils.randomDoubleArray(-bound, bound, len);
    }
  }
...

  {
    ...
    for(int i = 0; i < iteration; i++){
      int len = rand.nextInt(10) + 20;
      int bound = rand.nextInt(5) + 10;
      heapSortCase[i] = ArrayUtils.randomDoubleArray(-bound, bound, len);
    }
  }
...

  {
    ...
    for(int i = 0; i < iteration; i++){
      int len = rand.nextInt(10) + 20;
      int bound = rand.nextInt(5) + 10;
      quickSortCase[i] = ArrayUtils.randomDoubleArray(-bound, bound, len);
    }
  }
...

  {
    ...
    for(int i = 0; i < iteration; i++){
      int len = rand.nextInt(10) + 20;
      int bound = rand.nextInt(5) + 10;
      randQuickSortCase[i] = ArrayUtils.randomDoubleArray(-bound, bound, len);
    }
  }
...

  {
    ...
    for(int i = 0; i < iteration; i++){
      int len = rand.nextInt(10) + 20;
      int bound = rand.nextInt(5) + 10;
      countingSortCase[i] = ArrayUtils.randomIntArray(-bound, bound, len);
    }
  }
  ...
  static Sort.SimpleDate[] buildDate(){
    ...
    int[] years = ArrayUtils.randomIntArray(2000, 2022, len);
    int[] months = ArrayUtils.randomIntArray(1, 13, len);
    int[] days = ArrayUtils.randomIntArray(1, 29, len);
    for(int i = 0; i < len; i++){
...

  {
    ...
    for(int i = 0; i < iteration; i++){
      int len = rand.nextInt(10) + 20;
      bucketSortCase[i] = ArrayUtils.randomDoubleArray(0, 1, len);
    }
  }
