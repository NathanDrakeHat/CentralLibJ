...
import dev.qhc99.centralibj.algsJ.misc.SortTest;
...
import static dev.qhc99.centralibj.acm.ACM0x00.*;
...
public class ACM0x00Test {
...

  {
    ...
    for (int i = 0; i < iteration; i++) {
      ...
      ultraQuickSortCases[i] = ArrayUtils.randomDoubleArray(-bound, bound, len);
