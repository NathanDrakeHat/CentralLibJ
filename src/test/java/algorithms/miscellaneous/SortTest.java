...
class SortTest {
     static class Data {
        ...
        static int[] test2 = new int[] {-37, -8, 40, 5, -25, 15, -13, 12, 8, 44, 18, -6, -33, -37, -39, -24, -14, 15, 40, 27, -15, 46, -16, -2, 4};
        ...
        static double[] bucket_test = new double[] {0.885, 0.6497, 0.6566, 0.1263, 0.2799, 0.8863, 0.013, 0.8973, 0.4261, 0.454, 0.7068, 0.5867, 0.1529, 0.8356, 0.7301, 0.1111, 0.8368};
        static double[] bucket_test1 = new double[] {0.536, 0.3182, 0.7075, 0.8828, 0.3912, 0.7055, 0.1893, 0.9803, 0.5235, 0.4947, 0.6374, 0.9782};
        static double[] bucket_test2 = new double[] {0.9224, 0.8382, 0.2349, 0.4597, 0.2921, 0.2443, 0.2077, 0.8726, 0.7065, 0.2447, 0.7945, 0.2701, 0.4575, 0.1834, 0.3771};

         static int[] years = new int[] {2020, 2019, 2017, 2018, 2019, 2016, 2018, 2017, 2016, 2020, 2015, 2019, 2020, 2017, 2015, 2015, 2020, 2020, 2016, 2018};
